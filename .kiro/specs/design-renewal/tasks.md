...
- [x] 3. 共通コンポーネントスタイルの作成
- [x] 3.1 カードコンポーネントスタイルの実装
...
- [x] 6. ブログ記事レイアウトのリニューアル
- [x] 6.1 記事ヘッダー・メタデータの刷新
  - ヒーロー画像の表示スタイルを更新する
  - 日付、タグ表示のレイアウトを改善する
  - 読了時間の計算と表示を追加する
  - _Requirements: 6.1, 6.2_

- [x] 6.2 (P) Markdownコンテンツスタイルの統一
...
- [x] 7. ページ遷移とアニメーションの実装
- [x] 7.1 View Transitionsの有効化
  - ClientRouterコンポーネントをBaseHeadに追加する
  - ヘッダー・フッターにtransition:persistを設定する
  - ページ間遷移のスムーズな動作を確認する
  - _Requirements: 8.3_

- [x] 7.2 (P) レスポンシブブレークポイントの統一
